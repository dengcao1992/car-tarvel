                    ...
                    for (Map.Entry<byte[], byte[]> entry : familyMap.entrySet()) {
                        ...
                        for (Field field : fields) {
                            ...
                            if (fieldName.equalsIgnoreCase(colName)) {
                                ...
                                if ("class java.lang.String".equalsIgnoreCase(fieldType)) {
                                    field.set(t, colValue);
                                } else if ("class java.lang.Integer".equalsIgnoreCase(fieldType)){
                                    field.set(t, Integer.parseInt(colValue));
                                } else if ("class java.lang.Long".equalsIgnoreCase(fieldType)){
                                    field.set(t, Long.parseLong(colValue));
                                } else if ("class java.lang.Double".equalsIgnoreCase(fieldType)) {
                                    field.set(t, Double.parseDouble(colValue));
                                } else if ("class java.util.Date".equalsIgnoreCase(fieldType)) {
